...
public static class PermutationTables
{
    ...
    public static int[] PBlocksTable =
    {
    ...
    public static int[] PermutedChoice1Table =
    {
    ...
    public static int[] KeyShiftsTable =
    {
        1,  1,  2,  2,  2,  2,  2,  2,  1,  2,  2,  2,  2,  2,  2,  1,
    };

    // Таблица для сжатия ключа из 56 бит до 48 бит
    public static int[] CompressionTable =
    {
